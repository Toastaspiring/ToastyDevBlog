...
app.get('_api/posts', async c => {
  try {
    const { handle } = await import("./endpoints/posts_GET.js");
...
app.get('_api/event/next', async c => {
  try {
    const { handle } = await import("./endpoints/event/next_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/post/like', async c => {
  try {
    const { handle } = await import("./endpoints/post/like_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/post/create', async c => {
  try {
    const { handle } = await import("./endpoints/post/create_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/post/by-slug/:slug', async c => {
  try {
    const { handle } = await import("./endpoints/post/slug_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/users/:id', async c => {
  try {
    const { handle } = await import("./endpoints/user/id_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/post/comment', async c => {
  try {
    const { handle } = await import("./endpoints/post/comment_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.delete('_api/post/delete', async c => {
  try {
    const { handle } = await import("./endpoints/post/delete_DELETE.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.put('_api/post/update', async c => {
  try {
    const { handle } = await import("./endpoints/post/update_PUT.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/user/comments', async c => {
  try {
    const { handle } = await import("./endpoints/user/comments_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/user/liked-posts', async c => {
  try {
    const { handle } = await import("./endpoints/user/liked-posts_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/user/created-posts', async c => {
  try {
    const { handle } = await import("./endpoints/user/created-posts_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
