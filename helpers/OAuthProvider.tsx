...
export const oauthProviders = ["floot", "github"] as const;
...
export interface OAuthProviderInterface {
   ...
   * @returns Object containing the authorization URL and optional code verifier
   * 
   * Note: PKCE-based providers (e.g., Floot) must return codeVerifier.
   * Non-PKCE providers (e.g., GitHub) should omit codeVerifier.
   */
